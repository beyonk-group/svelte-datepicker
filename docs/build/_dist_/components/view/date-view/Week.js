...
function create_each_block(ctx) {
	...
	return {
		c() {
			...
			toggle_class(div, "part-of-range", /*config*/ ctx[8].isRangePicker && (/* eslint-disable no-mixed-operators */
			/*isStart*/ ctx[13] && isDateBetweenSelected(/*$date*/ ctx[3], /*$selectedEndDate*/ ctx[4], /*day*/ ctx[19].date) || !/*isStart*/ ctx[13] && isDateBetweenSelected(/*$selectedStartDate*/ ctx[5], /*$date*/ ctx[3], /*day*/ ctx[19].date)));
